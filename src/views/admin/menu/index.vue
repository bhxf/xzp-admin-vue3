    ...
    >
        <template v-slot:before>
            ...
            <x-dialog v-model="loadings['add']">
                ...
                <x-form ref="formRef" :fields="initMenuForm"/>
                <template #actions>
                    <q-btn :loading="loadings['save']" color="primary" unelevated label="保存" @click="onSave"/>
...
import {addMenu, getMenuList, getBaseMenuById, getBaseMenuByParentId, updateMenu, deleteMenu} from "@/api/system/menu";
...
const {search, tableSelected, treeSelected, treeTicked} = actionConst()
