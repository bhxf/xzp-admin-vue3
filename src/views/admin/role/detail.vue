<template>
    <div style="height: 600px;" class="flex column">
        <x-form-area ref="formAreaRef" :form-areas="formAreas">

            <template #baseAction>
                <q-btn :loading="loadings['saveBase']" round flat icon="save" color="primary" @click="onSaveBase">
                    <q-tooltip>保存基本信息</q-tooltip>
                </q-btn>
                <q-btn round flat icon="refresh" color="primary" @click="loadBase">
                    <q-tooltip>刷新</q-tooltip>
                </q-btn>
            </template>
            <template #menuAuthAction>
                <q-btn :loading="loadings['saveMenu']" round flat icon="save" color="primary" @click="onSaveMenu">
                    <q-tooltip>保存菜单信息</q-tooltip>
                </q-btn>
                <q-btn round flat icon="refresh" color="primary" @click="loadMenu">
                    <q-tooltip>刷新</q-tooltip>
                </q-btn>
            </template>
            <template #apiAuthAction>
                <q-btn :loading="loadings['saveApi']" round flat icon="save" color="primary" @click="onSaveApi">
                    <q-tooltip>保存API信息</q-tooltip>
                </q-btn>
                <q-btn round flat icon="refresh" color="primary" @click="loadApi">
                    <q-tooltip>刷新</q-tooltip>
                </q-btn>
            </template>

            <template #base>
                <x-form ref="formRef" :fields="roleFormAreas"/>
                <q-inner-loading
            ...
            <template #apiAuth>
                <div style="height: 450px" class="flex column">
                    <x-tree
                        ref="apiTreeRef"
                        node-key="ID"
                        tick-strategy="leaf"
            ...
            <template #loading>
                ...
                >
                    <div class="flex justify-center items-center q-gutter-x-sm">
                        <q-icon color="red" size="40px" name="warning_amber"/>
                        <div class="text-h5 text-red">未选中角色</div>
                    </div>
                </q-inner-loading>
            </template>
        </x-form-area>
